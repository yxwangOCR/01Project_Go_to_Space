    ...
    <div className='w-full bg-zinc-100 py-16'>
      <div className='max-w-[1240px] mx-auto'>
        <div className='text-center px-6'>
          ...
          <p className='text-2xl text-slate-600 py-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi nulla repellendus sint delectus officiis, velit beatae! Modi fuga praesentium pariatur laudantium, natus, aspernatur culpa dolor esse placeat repellendus reiciendis a?</p>
        </div>
